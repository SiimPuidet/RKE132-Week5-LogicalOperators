//Math >= 90 && Chemistry >= 90 || Math >= 90 && Biology >= 90 || Chemistry >= 90 && Biology >= 90
...
if((math >= 90 && chemistry >= 90) || (math >= 90 && biology >= 90) || (chemistry >= 90 && biology >= 90)) //seame tingimuse, et vähemalt kaks eksami tulemust peavad olema >= 90%
{
